...
public class CompanyResource {
    ...
    @RequestMapping(value = "/getCurrentCompanyInfo",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    @Transactional(readOnly = true)
    public CompanyDTO getCurrentCompanyInfo()
    {
        CompanyDTO companyDTO = companyMapper.companyToCompanyDTO(companyService.getCurrentCompanyInfo());
        return companyDTO;
    }
