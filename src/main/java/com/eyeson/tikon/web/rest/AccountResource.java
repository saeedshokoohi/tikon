...
public class AccountResource {
    ...
    public ResponseEntity<?> registerAccount(@Valid @RequestBody ManagedUserDTO managedUserDTO, HttpServletRequest request) {
        ...
        return userRepository.findOneByLogin(managedUserDTO.getLogin().toLowerCase())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(managedUserDTO.getEmail())
                ...
                .orElseGet(() -> userService.getUserByPhoneNumber(managedUserDTO.getPhoneNumber())
                    ...
                    .orElseGet(() -> {
                        User user = userService.createUserInformation(managedUserDTO.getLogin(), managedUserDTO.getPassword(),
                            ...
                            managedUserDTO.getLangKey(), managedUserDTO.getPhoneNumber());
                        ...
                        //Send SMS to for activation in here
     ...
     */
    @RequestMapping(value = "/activate/{login}/{key}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<String> activateAccount(@PathVariable("login") String login, @PathVariable("key") String key) {
        return userService.activateRegistration(login, key)
    ...
    @RequestMapping(value = "/activate/regenerate_key/{login}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public void regenarateActivationKey(@PathVariable("login") String login) {
         userService.generateNewActivationKey(login);
    }
