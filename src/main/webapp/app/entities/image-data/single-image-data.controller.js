(function() {
    ...
    angular
        .module('tikonApp')
        .controller('SingleImageDataController', SingleImageDataController);

    SingleImageDataController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'ImageData', 'AlbumInfo'];

    function SingleImageDataController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, ImageData, AlbumInfo) {
        var vm = this;
