(function() {
    ...
    angular
        .module('tikonApp')
        .controller('ServiceCategoryDialogController', ServiceCategoryDialogController);

    ServiceCategoryDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'ServiceCategory', 'SettingInfo', 'Company', 'Servant', 'AlbumInfo'];

    function ServiceCategoryDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, ServiceCategory, SettingInfo, Company, Servant, AlbumInfo) {
        var vm = this;
