(function() {
    ...
    function Auth ($rootScope, $state, $sessionStorage, $q, $translate, Principal, AuthServerProvider, Account, LoginService, Register, Activate, Password, PasswordResetInit, PasswordResetFinish, JhiTrackerService) {
        ...
        function activateAccount (login,key, callback) {
            var cb = callback || angular.noop;

            return Activate.activateByKey(login,key).get(
        ...
        function regenerateActivationKey (login, callback) {
            var cb = callback || angular.noop;

            return Activate.regenerateActivationKey(login).get(
