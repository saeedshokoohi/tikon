...
(function ($, window, document) {
    ...
    $.extend(Wickedpicker.prototype, {
        ...
        setText: function (input) {
            var valText=this.formatTime(this.selectedHour, this.selectedMin, this.selectedMeridiem, this.selectedSec);
            $(input).val(valText).change();
            if(this.options.valueChanged!=undefined)
            this.options.valueChanged(valText)
        },
