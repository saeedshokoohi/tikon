...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .post("/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "phoneNumber":"SAMPLE_TEXT", "activityType":null, "webSiteUrl":"SAMPLE_TEXT", "keyUrl":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
